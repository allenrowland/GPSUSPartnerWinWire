...
var StoryBrowser = /** @class */ (function (_super) {
    ...
    StoryBrowser.prototype.render = function () {
        ...
        return (React.createElement("section", { id: "storyBrowser", className: styles.storyBrowser },
                ...
                React.createElement("div", { className: styles.filtersDropdown },
                    ...
                    React.createElement("div", { className: styles.filters },
                        React.createElement("div", null,
                            ...
                            React.createElement(FilterGroup, { groupName: 'Industry', filterOptions: filters.filter(function (item) { return item.Field == 'Industry'; }), onChange: this.onSubmissionTypeFilterChange, activeFilters: this.state._storyBrowserStateFilters }),
                            React.createElement(FilterGroup, { groupName: 'SolutionArea', filterOptions: filters.filter(function (item) { return item.Field == 'SolutionArea'; }), onChange: this.onSubmissionTypeFilterChange, activeFilters: this.state._storyBrowserStateFilters })),
                        React.createElement("div", null,
                            React.createElement(FilterGroup, { groupName: 'PartnerType', filterOptions: filters.filter(function (item) { return item.Field == 'PartnerType'; }), onChange: this.onSubmissionTypeFilterChange, activeFilters: this.state._storyBrowserStateFilters }),
                            React.createElement(FilterGroup, { groupName: 'StoryType', filterOptions: filters.filter(function (item) { return item.Field == 'StoryType'; }), onChange: this.onSubmissionTypeFilterChange, activeFilters: this.state._storyBrowserStateFilters }),
                            React.createElement(FilterGroup, { groupName: 'Tags', filterOptions: filters.filter(function (item) { return item.Field == 'Tags'; }), onChange: this.onSubmissionTypeFilterChange, activeFilters: this.state._storyBrowserStateFilters }))))),
            ...
            React.createElement("div", { className: styles.sortResults },
                React.createElement("select", { value: this.state._storyBrowserStateSort, onChange: this.handleSortChange },
                ...
                React.createElement("span", null, story.GSPUSStoryHelper._resultCount(filteredStories))),
    ...
    StoryBrowser.prototype.filterStories = function (stories) {
        ...
        if (this.state._storyBrowserStateFilters.length > 0) {
            var filters_1 = this.state._storyBrowserStateFilters;
            var filteredStories_1 = [];
            stories.forEach(function (storyItem) {
                var pushStory = false;
                filters_1.forEach(function (filterItem) {
