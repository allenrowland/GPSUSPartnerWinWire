...
var StoryBrowser = /** @class */ (function (_super) {
    ...
    StoryBrowser.prototype.render = function () {
        ...
        var otherStories = this.props.stories;
            ...
            React.createElement("div", { id: "filters", className: styles.filtersContainer },
                React.createElement("div", { className: styles.filtersDropdown },
                    ...
                    React.createElement("div", { className: styles.filters },
                        ...
                        React.createElement("div", { className: styles.filtersOptions },
                            React.createElement("div", { className: styles.FirstRow },
                                React.createElement("strong", null, "Industry:"),
                                React.createElement("ul", null, this.props.filters.filter(function (item) { return item.Field == 'Industry'; }).map(function (value, index) {
                                    return React.createElement("li", null,
                                        React.createElement("input", { type: "checkbox", value: "{value.Value}", checked: value.IsChecked }),
                                        " ",
                                        value.Value);
                                })),
                                React.createElement("br", null),
                                React.createElement("strong", null, "Solution area:"),
                                React.createElement("ul", null, this.props.filters.filter(function (item) { return item.Field == 'SolutionArea'; }).map(function (value, index) {
                                    return React.createElement("li", null,
                                        React.createElement("input", { type: "checkbox", value: "{value.Value}", checked: value.IsChecked }),
                                        " ",
                                        value.Value);
                            ...
                            React.createElement("div", null,
                                ...
                                React.createElement("ul", null, this.props.filters.filter(function (item) { return item.Field == 'PartnerType'; }).map(function (value, index) {
                                    return React.createElement("li", null,
                                        React.createElement("input", { type: "checkbox", value: "{value.Value}", checked: value.IsChecked }),
                                        " ",
                                        value.Value);
                                ...
                                React.createElement("ul", null, this.props.filters.filter(function (item) { return item.Field == 'StoryType'; }).map(function (value, index) {
                                    return React.createElement("li", null,
                                        React.createElement("input", { type: "checkbox", value: "{value.Value}", checked: value.IsChecked }),
                                        " ",
                                        value.Value);
                                ...
                                React.createElement("ul", null, this.props.filters.filter(function (item) { return item.Field == 'Tags'; }).map(function (value, index) {
                                    return React.createElement("li", null,
                                        React.createElement("input", { type: "checkbox", value: "{value.Value}", checked: value.IsChecked }),
                                        " ",
                                        value.Value);
                ...
                React.createElement("div", { className: styles.filtersSearch },
                    React.createElement("input", { className: styles.partnerSearch, style: inputStyle, placeholder: "Search by partner name", type: "text", name: "namesearch" }),
                    " ",
                ...
                React.createElement("div", { className: styles.sortResults },
                    React.createElement("button", { className: styles.sortBtn },
                        ...
                        " ",
                        React.createElement(ChevronDownIcon, null)),
                    React.createElement("p", null, story.GSPUSStoryHelper._resultCount(this.props.stories)))),
    ...
    StoryBrowser.prototype.storyCard = function (item) {
        return (React.createElement("div", { className: styles.item },
            ...
            React.createElement("a", { className: styles.itemTitle, href: "${item.URL}" }, item.Title),
