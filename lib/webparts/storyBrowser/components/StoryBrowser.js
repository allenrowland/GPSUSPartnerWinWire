...
var StoryBrowser = /** @class */ (function (_super) {
    ...
    StoryBrowser.prototype.render = function () {
        ...
        return (React.createElement("section", { id: "storyBrowser", className: styles.storyBrowser },
            ...
            React.createElement("div", { className: styles.filtersSearch },
                React.createElement("input", { style: inputStyle, placeholder: "Search by partner name", type: "text", name: "namesearch", onBlur: this.handleInputChanged.bind(this) }),
                " ",
    ...
    StoryBrowser.prototype.handleInputChanged = function (event) {
        this.setState({
